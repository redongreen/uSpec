...
<Note>
  Roughly 85% of the pipeline is deterministic scripts (extraction, rendering, measurements) and 15% is AI reasoning (section planning, notes, anomaly detection). Output is highly consistent across runs.
</Note>
