...
<Tabs>
  <Tab title="Cursor">
    ...
    <Steps>
      ...
      <Step title="Select the right model">
        uSpec skills are token-intensive and require a model with high context capacity. In Cursor's chat, select **OpenAI GPT 5.4 Medium Thinking** or a stronger model.

        <Warning>
          Lower-capacity models may truncate instructions mid-skill, producing incomplete or broken specs. **OpenAI GPT 5.4 Medium Thinking** is the minimum recommended model.
        </Warning>
      </Step>
    </Steps>
  ...
  <Tab title="Claude Code">
    ...
    <Steps>
      ...
      <Step title="Select the right model">
        Use **OpenAI GPT 5.4 Medium Thinking** or a stronger model. uSpec skills are token-intensive and require high context capacity.
      </Step>
    </Steps>
  ...
  <Tab title="Codex">
    ...
    <Steps>
      ...
      <Step title="Select the right model">
        Use **OpenAI GPT 5.4 Medium Thinking** or a stronger model. uSpec skills are token-intensive and may produce incomplete output with lower-capacity models.
      </Step>
    </Steps>
