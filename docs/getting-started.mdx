...
description: "Set up your AI agent, Figma Console MCP, and template library, then create your first spec"
---
...
The [Figma Console MCP](https://github.com/southleft/figma-console-mcp) connects your agent to Figma Desktop, giving it access to component data, variables, styles, and screenshots.
