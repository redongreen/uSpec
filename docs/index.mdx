...
<Note>
**v1.8.1** — Structure skill now recursively measures nested containers and enforces per-wrapper padding coverage. Color specs composite styles (gradients, multi-layer fills). Property skill drastically improved. [See changelog](/help/changelog).
</Note>
