...
<Note>
**v1.8.0** — Color now specs composite styles (gradients, multi-layer fills) with nested hierarchy breakdowns. Property skill drastically improved with exhibit planning, context axis rendering, and sparse matrix support. [See changelog](/help/changelog).
</Note>
