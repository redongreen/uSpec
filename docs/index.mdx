...
<Note>
**v1.7.4** — Figma slot support across all skills. API skill gains evidence-based reasoning with ownership hints, override promotion for compound components, and a structured evidence model separating deterministic facts from AI interpretation. [See changelog](/help/changelog).
</Note>
