...
<Note>
**v1.7.3** — Figma slot support across all skills, ownership-aware structure planning, hosting-context slot sections, and new screen reader support for preferred slot fills in focus-order analysis and artwork previews. [See changelog](/help/changelog).
</Note>
