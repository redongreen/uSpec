...
<Note>
**v1.7.2** — Figma slot support across all skills + ownership-aware structure planning, single-path slot/sub-component classification, and hosting-context slot sections. [See changelog](/help/changelog).
</Note>
