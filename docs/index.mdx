...
<Note>
**v1.2.0** — Drastically improved create-structure skill: Figma-native measurements, template-driven previews, and a deterministic/AI split for consistent output. [See changelog](/help/changelog).
</Note>
